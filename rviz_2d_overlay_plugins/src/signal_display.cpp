...
namespace rviz_2d_overlay_plugins
{
    ...
    void SignalDisplay::onInitialize()
    {
        ...
        gear_topic_property_ = std::make_unique<rviz_common::properties::RosTopicProperty>("Gear Topic", "/vehicle/status/gear_status", "", "Topic for Gear Data", this);
        turn_signals_topic_property_ = std::make_unique<rviz_common::properties::RosTopicProperty>("Turn Signals Topic", "/vehicle/status/turn_indicators_status", "", "Topic for Turn Signals Data", this);
        speed_topic_property_ = std::make_unique<rviz_common::properties::RosTopicProperty>("Speed Topic", "/vehicle/status/velocity_status", "", "Topic for Speed Data", this);
        steering_topic_property_ = std::make_unique<rviz_common::properties::RosTopicProperty>("Steering Topic", "/vehicle/status/steering_status", "", "Topic for Steering Data", this);
        hazard_lights_topic_property_ = std::make_unique<rviz_common::properties::RosTopicProperty>("Hazard Lights Topic", "/vehicle/status/hazard_lights_status", "", "Topic for Hazard Lights Data", this);
    }
