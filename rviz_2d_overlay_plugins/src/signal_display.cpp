...
namespace rviz_2d_overlay_plugins
{
    ...
    void SignalDisplay::onInitialize()
    {
        ...
        // traffic_topic_property_ = std::make_unique<rviz_common::properties::RosTopicProperty>("Traffic Light Topic", "/perception/traffic_light_recognition/traffic_signals", rosidl_generator_traits::data_type<autoware_perception_msgs::msg::TrafficSignalArray>(), "Topic for Traffic Light Data", this, nullptr, this);
    }
    ...
    // void SignalDisplay::updateTrafficLightData(const autoware_perception_msgs::msg::TrafficSignalArray::ConstSharedPtr msg)
    // {
    //     std::lock_guard<std::mutex> lock(property_mutex_);
