...
namespace rviz_2d_overlay_plugins
{
    ...
    // void TrafficDisplay::updateTrafficLightData(const autoware_perception_msgs::msg::TrafficSignalArray::ConstSharedPtr msg)
    // {
    ...
    void TrafficDisplay::drawTrafficLightIndicator(QPainter &painter, const QRectF &backgroundRect)
    {
        ...
        QRectF imageRect = circleRect.adjusted(15, 15, -15, -15); // Adjusting the rectangle to make the image smaller

        // make the image thicker
        painter.setPen(QPen(Qt::black, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin));
        // Draw the traffic light image on top of the circle
        painter.drawImage(imageRect, traffic_light_image_.scaled(imageRect.size().toSize(), Qt::KeepAspectRatio, Qt::SmoothTransformation));
    }
...
PLUGINLIB_EXPORT_CLASS(rviz_2d_overlay_plugins::TrafficDisplay, rviz_common::Display)
